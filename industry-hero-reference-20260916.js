...
}const css=document.createElement('link');css.rel='stylesheet';css.href='https://cdn.jsdelivr.net/gh/suguru1215/nobe-css@93cda4d/css/industry-hero-reference-20260916.css';css.onload=function(){if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',init);else init();};document.head.append(css);})();
